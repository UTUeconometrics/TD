...
- Seuraavaksi perehdytään tarkemmin kahteen kenties useimmiten tarkasteltavaan tunnuslukuun ja niiden otosjakaumiin: 
  - Aritmeettisen keskiarvon otosjakaumaa \@ref(alaluku63)
  - Suhteellisen osuuden (frekvenssin) otosjakaumaa \@ref(alaluku64)
...
```{r, echo=FALSE, fig.cap="Standardoitu normaalijakauma: Virhemarginaaleja", fig.align='center', out.width = "75%"}
...
- Tarkastellaan kuitenkin ensin minkälaiset kysymykset liittyvät otoskoon pohdintaan tulosten tarkkuuden osalta. 
  ...
  - Kuinka varma haluat olla, että otos edustaa joukkoa oikein? Tämä on luottamustaso. 
    ...
    - Jos joukosta poimitaan 30 otosta sattumanvaraisesti, kuinka usein yhdestä otoksesta saadut tulokset eroavat merkittävästi muista 30 otoksesta? Jos luotettavuustaso on 95%, samat tulokset saadaan 95 prosentissa tapauksista. 
