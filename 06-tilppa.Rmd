...
- Havaintoarvot $y_1, \ldots, y_n$ ovat kiinteitä lukuja, mutta ne vaihtelevat satunnaisesti otoksesta toiseen. Satunnaisotannassa __satunnaisuus liittyy siis havaintoarvojen vaihteluun satunnaisesti otoksesta toiseen__. 
...
```{r, echo=FALSE, fig.cap="Standardoitu normaalijakauma: Virhemarginaaleja"}
