...
- Tarkastellaan kuitenkin ensin minkälaiset kysymykset liittyvät otoskoon pohdintaan tulosten tarkkuuden osalta. 
  ...
  - Kuinka varma haluat olla, että otos edustaa joukkoa oikein? Tämä on luotettavuustaso. 
    - Luotettavuustaso on todennäköisyys sille, että valitsemasi otos on tulosten kannalta oleellinen.
