...
- Regressioanalyysi pyrkii siis havaintoaineiston perusteella __mallintamaan tilastoyksikköjen tilastollisten muuttujien välistä riippuvuutta__.
  - Regressiomallissa tilastollisia muuttujia on kahdenlaisia: __selitettävä muuttuja__, jonka tilastollista vaihtelua pyritään selittämään __selittävän muuttujan__ vaihtelulla. 
