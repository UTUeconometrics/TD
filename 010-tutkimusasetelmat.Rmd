...
- Kokeen tavoitteena on tehdä kokeen tulosten perusteella yleisiä johtopäätöksiä uuden lääkkeen tehokkuudesta. Miten yhdestä kokeesta saadut tulokset voidaan yleistää koskemaan kaikkia tautia sairastavia potilaita?
  - Kokeen tulokset voidaan yleistää, jos kokeessa uutta ja vanhaa lääkettä saavien potilaiden ryhmät ovat samankaltaisia kaikissa muissa suhteissa paitsi siinä, että niihin kohdistetaan kokeessa erilainen käsittely.
    ...
    - Kokeen kohteiden jakamista erilaisen käsittelyn kohteiksi joutuviin ryhmiin arpomalla kutsutaan tilastotieteessä __satunnaistamiseksi__.
...
- __Havainnoiva tutkimus__
  ...
  - __Havainnoivan tutkimuksen haitat}
...
### __Poikittaistutkimukseksi__ tai __poikkileikkaustutkimukseksi__ kutsutaan tutkimusstrategiaa, jossa tarkoituksena on tutkia kohdetta tai ilmiötä laaja-alaisesti tiettynä ajankohtana käyttäen poikkileikkausaineistoja.
...
### __Pitkittäistutkimuksessa__ seurataan usein samoja tilastoyksiköitä "yli ajan", eli mittauspisteitä on useita ja pitkältä aikaväliltä.
- Pitkittäistutkimuksessa hyödynnetään niin aikasarja- kuin paneeliaineistojakin.
...
### __Kohorttitutkimus__ on altistelähtöinen tapa toteuttaa pitkittäistutkimus.
...
```{r hiroshima, echo=FALSE, fig.cap="Esimerkki pitkittäistutkimuksesta", fig.align='center', out.width = "100%"}
...
```{r tali, echo=FALSE, fig.cap="Esimerkki pitkittäistutkimuksesta", fig.align='center', out.width = "100%"}
...
```{r kuluttaja, echo=FALSE, fig.cap="Esimerkki: Kansainvälisten lentomatkustajien lkm vuosina 1949-1960", fig.align='center', out.width = "100%"}
...
```{r survey, echo=FALSE, fig.cap="Esimerkki survey-tutkimuksesta. (Kuva 1)", fig.align='center', out.width = "100%"}
knitr::include_graphics("images/survey.jpg")
```

```{r survey2, echo=FALSE, fig.cap="Esimerkki survey-tutkimuksesta. (Kuva 2)", fig.align='center', out.width = "100%"}
knitr::include_graphics("images/survey2.jpg")
```

```{r survey3, echo=FALSE, fig.cap="Esimerkki survey-tutkimuksesta. (Kuva 3)", fig.align='center', out.width = "100%"}
