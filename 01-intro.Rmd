...
Kurssin mittaan esitellään tilastotieteen perusteiden lisäksi __miten TY:ssa tilastotieteen opinnoissa syvennytään__ tällä kurssilla esiteltäviin menetelmiin, aineistotyyppeihin ja mallinnuskokonaisuuksiin. Tilastotieteen opintotarjonta löytyy [Turun yliopiston opinto-oppaasta](https://opas.peppi.utu.fi/fi/ohjelma/89589)!
