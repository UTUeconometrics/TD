...
```{r datasc, echo=FALSE, fig.cap="Tilastotieteen ja rajatieteiden yhteyksiä kuvaava Venn-diagrammi. ([Duchesnay, 2020](https://duchesnay.github.io/pystatsml/introduction/machine_learning.html))", fig.align='center', out.width = "100%"}
