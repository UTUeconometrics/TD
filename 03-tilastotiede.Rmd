...
- Yritetään siis vielä hahmotella tilastotieteen suhdetta sitä lähimpänä olevaan (soveltavaan) matematiikkaan.
  ...
  - Matematiikassa kuvataan ongelma ja esitetään se teorian muodossa, malli on _"parametreista havaintoihin"_
...
__"Yleismaailmallinen kritiikki"__
...
Oletetaan että tutkijana haluat tutkia onko kahden eri ikäryhmän ihmisten pituuksissa eroja ja sinulla on käytettävissä edustava otos molempien ikäluokkien edustajista. Tutkit siis onko toisen ryhmän, ryhmän A, keskipituus _pienempi_ kuin ryhmän B ja testaat päteekö tämä _yksisuuntaisesti_. Testitulos osoittaa, että voit hylätä nollahypoteesin, jonka mukaan ryhmien keskipituus olisi sama. Kolmannen tyypin virhe syntyy silloin, jos tosiasiallisesti testin hylkääminen johtui siitä, että ryhmän A keskipituus olikin _suurempi_ kuin ryhmän B keskipituus, mutta tätä et testin tuloksen perusteella voi tietää!   
:::
...
- Tietojenkäsittelytieteen alaan (osittain) lukeutuvia tutkimusaloja
    ...
    - [Knowledge discovery,](https://en.wikipedia.org/wiki/Knowledge_extraction)\href{}{}, 
    - [Hahmontunnistus,](https://en.wikipedia.org/wiki/Pattern_recognition)\href{}{}, 
    - [Tekoäly,](https://en.wikipedia.org/wiki/Artificial_intelligence)\href{}{},
    - [Koneoppiminen](https://en.wikipedia.org/wiki/Machine_learning)\href{}{},
- Ja paljon muita!
