...
```{r isatjapojat1, echo=FALSE, fig.cap="Isien ja poikien pituudet. Lähde: Mellin (2006).", fig.align='center', out.width = "100%"}
...
```{r korrelaatioMellin, echo=FALSE, fig.cap="Havainnollistuksia Pearsonin otoskorrelaatiokertoimen arvosta ja erilaisista $xy$-pisteparvista. Lähde: Mellin (2006).", fig.align='center', out.width = "100%", message = FALSE, warning = FALSE}
...
```{r, echo = FALSE}
knitr::include_url("http://guessthecorrelation.com/")
```
...
```{r causality, echo=FALSE, fig.cap="Kausaalisuus: kumpi tuli ensin?", fig.align='center', out.width = "100%"}
knitr::include_graphics("images/causality.jpg")
```
...
```{r, echo=FALSE, fig.cap="Esimerkkejä: luomuruoka syypää lisääntyneisiin autismitapauksiin?", fig.align='center', out.width = "100%"}
...
```{r simpson, echo=FALSE, fig.cap="Simpsonin paradoksi", fig.align='center', out.width = "100%"}
...
library(tidyverse)
library(knitr)
taulukko = rbind.data.frame(m,n)
rownames(taulukko) = c("Miehet", "Naiset")
colnames(taulukko) = c("Hakijat", "Hyväksytyt")
...
kable(taulukko, booktabs = TRUE) %>% 
  kable_styling(font_size = 12, latex_options = "scale_down") %>% 
  add_header_above(c("Miehet" = 2, "Naiset" = 3))
```
