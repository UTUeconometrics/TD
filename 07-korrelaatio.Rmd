...
```{r, echo=FALSE, fig.cap="Isien ja poikien pituudet. Lähde: Mellin (2006)."}
...
```{r, echo=FALSE, fig.cap="Havainnollistuksia Pearsonin otoskorrelaatiokertoimen arvosta ja erilaisista $xy$-pisteparvista. Lähde: Mellin (2006)."}
...
```{r, echo=FALSE, fig.cap="Esimerkkejä: luomuruoka syypää lisääntyneisiin autismitapauksiin?"}
...
```{r, echo=FALSE, fig.cap="Simpsonin paradoksi"}
